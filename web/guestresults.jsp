...
<head>
    ...
    <title>Guest Certificate Verification Results</title>
...
<div id="page">
    <div class="page-title">
        <h3>Guest Certificate Verification Results</h3>
    </div>
            ...
            <div class="row">
                ...
                <div class="col-xs-10 text-right menu-1">
                    <ul>
                        ...
                        <li><a href="guest.jsp">Guest Verification</a></li>
                        <li class="active"><a href="guestresults.jsp">Results</a></li>
    ...
    <div class="results-container">
        ...
        %>
            <div class="authentic-alert">
                ...
                <p style="font-size: 18px; margin: 0;">
                    This certificate is genuine and has not been modified since upload.
                </p>
            </div>
            ...
            <div class="action-buttons">
                <a href="guest.jsp" class="btn-analyze">Check Another Certificate</a>
        ...
        %>
                        <div class="tampering-alert">
                            ...
                            <div class="action-buttons">
                                ...
                                <a href="guest.jsp" class="btn-analyze">
        ...
        %>
                    <div class="tampering-alert">
                        ...
                        <div class="action-buttons">
                            <a href="guest.jsp" class="btn-analyze">Try Again</a>
                            <a href="index.jsp" class="btn-back">Back to Home</a>
                        </div>
                    </div>
        <%
        ...
        %>
            <div class="error-alert">
                <div class="error-title">Student Not Found</div>
                <p style="font-size: 18px; margin: 0;">
                    The student with USN "<%= usn != null ? usn : "Unknown" %>" was not found in the blockchain.
                </p>
                <div class="action-buttons">
                    <a href="guest.jsp" class="btn-analyze">Check Another Certificate</a>
                    <a href="index.jsp" class="btn-back">Back to Home</a>
        ...
        <% } else if ("filenotfound".equals(status)) { %>
            <div class="error-alert">
                <div class="error-title">Certificate File Not Found</div>
                <p style="font-size: 18px; margin: 0;">
                    The certificate file for USN "<%= usn != null ? usn : "Unknown" %>" was not found on the server.
                </p>
                <div class="action-buttons">
                    <a href="guest.jsp" class="btn-analyze">Check Another Certificate</a>
                    <a href="index.jsp" class="btn-back">Back to Home</a>
                 ...
                 <% } else if ("error".equals(status)) { %>
                           <div class="error-alert">
                  <div class="error-title">Invalid Hash Entered</div>
                  <p style="font-size: 18px; margin: 0;">
                      The hash value you entered does not match the stored hash for USN "<%= usn != null ? usn : "Unknown" %>". 
                      Please check the hash value and try again.
                  </p>
                  <div class="action-buttons">
                      <a href="guest.jsp" class="btn-analyze">Try Again</a>
                      <a href="index.jsp" class="btn-back">Back to Home</a>
        ...
        <% } else { %>
            <div class="error-alert">
                ...
                <p style="font-size: 18px; margin: 0;">
                    Please verify a certificate first to see the results.
                </p>
                <div class="action-buttons">
                    <a href="guest.jsp" class="btn-analyze">Check Certificate</a>
                    <a href="index.jsp" class="btn-back">Back to Home</a>
                </div>
            </div>
        <% } %>
